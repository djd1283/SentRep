...
class SNLIClassifierFromModel(nn.Module):
    def __init__(self, model, model_size, d_out=3):
        super().__init__()
        self.model = model
        self.out_layer = nn.Linear(model_size * 3, d_out)
    ...
    def forward(self, premise, hypothesis):
        ...
        all_emb = torch.cat([premise_emb, hypothesis_emb, torch.abs(premise_emb - hypothesis_emb)], -1)
